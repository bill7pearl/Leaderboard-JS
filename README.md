...
> This is A simple but effective and responsive (mobile first) Microverse exercise project.
>
> **Leaderboard** is a tool that shows your game score by getting it from an external API.
...
- **User can add his game score]**
- **User can refresh the scores list to see his classification**
...
```sh
git clone https://github.com/bill7pearl/Leaderboard-JS.git
```
